...
const logger = (0, logger_mjs_1.getLogger)();
class TrashScheduleService {
    ...
    calculateLocalTime(target_day) {
        ...
        const timeZoneMoment = moment_timezone_1.default.tz.zone(this.timezone);
        if (timeZoneMoment) {
    ...
    */
    ...
    async compareTwoText(target, comparison) {
        ...
        try {
            ...
            const compareResult = (0, msgpack_1.decode)(Buffer.from(response_body, "base64"));
    ...
    async compareMultipleTrashText(target, comparisons) {
        ...
        try {
            ...
            const compareResult = (0, msgpack_1.decode)(decoded_body);
            return compareResult;
        }
        catch (err) {
            logger.error(err);
